...
const { mobileAuditFrontPage, webDisclaimer, tableOfContent_web, documentControl, introduction, scope, term_defination_legends, toolsAndReferences, executiveSummary, template_css, assessmentMethodology_web_mobile_api, toolsAndReferences_mobile } = require('../json/auditJSON');
// import mobileAuditFrontPage from "../json/auditJSON"
...
`
    ...
    <div class="body_template_class">
    <h4 class="content_heading " id="assessment_findings_overview">7. Assessment Findings Overview 
    </h4>
    ...
    <!--FRont  page -->
    ${mobileAuditFrontPage(reportData.ReportDetails.AuditeeOrganizationDetails.OrganizationLogo , reportData.ReportDetails.AuditeeOrganizationDetails.OrganizationName)}
    ...
    <!-- page introduction -->
    ${introduction(reportData.ReportDetails.ScopeDetails.ScopeName , "Mobile")}
    ...
    ${assessmentMethodology_web_mobile_api("mobile apps")}
