...
<div class="logo">   <img src="${process.env.AUDITOR_API_URI}/images/logo-001.png"
style="width:100%; max-width:300px;"></div>
    ...
    <div class="body_template_class table_of_content">
        ...
        <div class="content">
            <a href="#disclaimer" >1. Disclaimer  3</a>
            <a href="#document_control">2.
            DOCUMENT CONTROL  4</a>
            <div class="sub_content">
               <a  href="#version_history"> 2.1 VER SION HISTORY</a>
                <a  href="#contact_info">2.2 CONTACT INFORMATION</a> 
            </div>
            <a  href="#introduction"><div>3. INTRODUCTION</div> <div>3</div> </a>
            <div class="sub_content">
               <a  href="#summary"> 3.1 SUMMARY</a>
                <a  href="#aim">3.2 AIM</a>
                <a  href="#assessment_objective">3.3 ASSESSMENT OBJECTIVE </a>
                <a  href="#xiarch_sol_pvt_ltd_audit_team">3.4 Xiarch Solutions Private Limited SECURITY AUDIT TEAM</a>
            </div>
            <a  href="#scope">4. SCOPE</a>
            <a  href="#term_defination_legends">5. TERMS , DEFINATIONS AND LEGENDS</a>
            <div class="sub_content">
               <a  href="#vulnerability_table"> 5.1 VULNERABILITY TABLE </a>
               <a  href="#title_of_finding"> 5.2 TITLE OF THE FINDING - A SHORT TITLE THAT DESCRIBES THE FINDINGS </a>
            </div>
           <a  href="#methodology"> 6. METHODOLOGY</a>
            <div class="sub_content">
                <a  href="#reporting_and_analysis">6.1 REPORTING AND ANALYSIS PHASE</a>
                <a  href="#testing_phase">6.2 TESTING PHASE </a>
                <a  href="#audit_methodology">6.3 AUDIT METHODOLOGY WHICH WE FOLLOW</a>
                <div class="sub_sub_content">
                    <a  href="#information_gathering">6.3.1 nformation Gathering</a>
                    <a  href="#document_control">6.3.2 Configuration and Deplyment Managment Testing </a>
                    <a  href="#document_control">6.3.3 Identity Managment Testing</a>
                    <a  href="#document_control">6.3.4 Authentication Testing </a>
                    <a  href="#document_control">6.3.5 Autherization Testing </a>
                    <a  href="#document_control">6.3.6 Session Managment Testing </a>
                    <a  href="#document_control">6.3.7 Input Validation Testing </a>
                    <a  href="#document_control">6.3.8 Testing For Error Handling  </a>
                    <a  href="#document_control">6.3.9 Testing For Week Cryptography </a>
                    <a  href="#document_control">6.3.10 Business Logic Testing  </a>
                    <a  href="#document_control">6.3.11 Client Side  Testing  </a>

                </div>
            </div>
            <a  href="#document_control">7. EXECUTIVE SUMMARY</a>
            <a  href="#document_control">8. SUMMARY OF VULNERABILITIES</a>
            <a  href="#document_control">9. DETAILED FINDING AND RECOMMENDATIONS</a>
            <div class="sub_content">
                <a  href="#document_control">9.1 Fingerprint Web Search </a>
            </div>
            <a  href="#document_control">10. TOOLS AND REFERENCES </a>
        </div>
    </div>
    `
    ...
    <div class="body_template_class disclaimer ">
        <div class="content_heading" id="disclaimer">1. DISCLAIMER</div>
    ...
    <div class="body_template_class document_control">
        <div class="body_template_class disclaimer">
            <div class="content_heading" id="document_control">2. DOCUMENT CONTROL</div>
            <div class="">
    ...
    <div class="body_template_class">
        <div class="content_heading" id="term_defination_legends">6. METHODOLODY</div>
        <div class="sub_content_heading" id="summary">6.1 REPORTING AND ANALYSIS PHASE :
            <div class="content">
                <div class="sub_content">
    ...
    <div class="body_template_class">
        ...
        <div class="content_heading" id="term_defination_legends">7. EXECUTIVE SUMMARY
    ...
    let page_12 = `
    <div class="body_template_class">
        <div class="content_heading" id="term_defination_legends">8. SUMMARY OF VULNERABILITIES
    ...
    <div class="body_template_class ">
        <div class="content_heading" id="introduction">11. TOOLS AND REFERENCES</div>
...
`
    ...
    <!-- pagedynamic pages  -->
    ${list.map((data, index) => (
        ` <div class="page" >${vuul_list(data, index)}</div>`
    )).join('')} 
