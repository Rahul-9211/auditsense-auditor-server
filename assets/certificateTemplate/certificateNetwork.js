...
module.exports = (data, checkListType, auditorName) => {
    console.log("certificate data this ", data)
    ...
    <body>
        ...
        <p class="main-header">Certificate of Network Audit</p>
            ...
            <table class="table table-borderless">
                <tbody>
                    ...
                    <tr class="for_table_height">
                        <td scope="row" class="for_table_height p-0"> In Scope IP</td>
                        <td class=" p-0">:</td>
                    ...
                    <tr class="for_table_height">
                        ...
                        <td class=" p-0">:</td>
                        <td class=" p-0 ps-2">Network & System Audit</td>
                    </tr>
                    <tr class="for_table_height">
        ...
        <p class="subHeader">Conclusion : </p>
         <p class="content">Auditing for <strong>${data.CertificateDetails.AuditeeOrganizationDetails.OrganizationName}</strong> servers was done from
            <strong>${current_date}</strong>
            to
            <strong>${updated_complete_date}</strong> as per the CERT-In Server Audit guidelines, by Xiarch Solutions as per the
            scope. <br /><br />
            As on <strong> ${current_date}</strong>, there are no pending nonconformity w.r.t Server Audit.<br /><br />
            The clearance for the above server is given taking into consideration that currently high
and Critical vulnerabilities do not exist on the Server. Any unapproved changes to the
hardware/software configuration of the server will void the certificate.

        </p>
      
        <div class="recommendationBox">
            <p class="sub-subHeader">Recommendation : </p>
            <p class="sub-content">I. Proper patching of the server should be done at least twice a year.<br />
                II. Server Audit should be done every one year.<br />
                III. No Applications or software should be installed without proper security audit.<br />
