...
module.exports = (data, checkListType, auditorName) => {
    ...
    //    data.CertificateScope = data.CertificateScope.replace( /(<([^>]+)>)/ig, '')
    // console.log("path", data)
    let CertificateScope = data.CertificateDetails.ScopeDetails.CertificateScope
    console.log(CertificateScope)
    // data = data[0]
    return `<!doctype html>
    <html>
            ...
            <div class="invoice-box">   
                ...
                <div class="for">
                    <table class="table table-borderless">
                        ...
                        <td scope="row" class="for_table_height p-0"> In Scope URL</td>
                        <td class=" p-0">:</td>
                    ...
                    <tr class="for_table_height">
                        ...
                        <tr class="for_table_height">
                            ...
                            <tr class="for_table_height">
                                <td scope="row" class=" p-0">Audit Type</td>
                                <td class=" p-0">:</td>
                                <td class=" p-0 ps-2">${checkListType}</td>
                            </tr>
                            <tr class="for_table_height">
                ...
                <p class="content">Auditing for <strong>${data.CertificateDetails.AuditeeOrganizationDetails.OrganizationName}</strong> web application of
                ...
                the CERT-In Web Application Audit guidelines, by Xiarch Solutions as per the scope. As on
                <strong>${current_date}</strong>, there are no pending nonconformity w.r.t Web Application Audit.
                 <br /><br />
                ...
                <p class="content">I. Site may be considered safe for hosting with Read and Script Execute permission
                    only<br />
                    II. Read and Write permission should be granted only on the folder where the files are to
                    be uploaded given at the following URL:
                    ${data.CertificateDetails.ScopeDetails.CertificateScope}
                </p>
